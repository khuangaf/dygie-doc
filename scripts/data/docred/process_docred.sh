...
python scripts/data/docred/convert_docred2entlvl.py --input_dir $raw_dir --output_dir $processed_dir
...
python scripts/data/docred/split_dev.py --dev_path $processed_dir/dev.entlvl.json --devdev_list_path $devdev_list_path --devtest_list_path $devtest_list_path --devdev_output_path $processed_dir/devdev.entlvl.json --devtest_output_path $processed_dir/devtest.entlvl.json